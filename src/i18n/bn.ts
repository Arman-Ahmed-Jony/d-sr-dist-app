export const bn = {
  ...
  loginTitle: 'এসআর ডিস্ট',
  loginSubtitle: 'মাঠে অর্ডার নিতে সাইন ইন করুন',
  ...
  deleteDraftConfirm: 'এই খসড়া অর্ডার মুছবেন? এটি ফেরানো যাবে না।',
  errorDeleteOrder: 'খসড়া অর্ডার মুছা যায়নি।',
  cancel: 'বাতিল',
  viewMode: 'ভিউ',
  viewOrders: 'অর্ডার',
  viewLines: 'পণ্য লাইন',
